...
function cvContents() {
  return (
    <React.Fragment>
      ...
      <p>
        William and Hairy College, Professor of Molecular Bioinformatics, Fall 2009-Present
      </p>
      ...
      <p>"Nepata cataria in Yellow Knife: A struggle for survival and recommendations for intervention", <em>Yellow Knife Journal of Molecular Biology</em>, iss. 43, pp.322-63 (2015)</p>
